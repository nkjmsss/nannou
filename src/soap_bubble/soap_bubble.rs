...
fn rotate_x(point: Point3, degree: f32, orientation: Point3) -> Point3 {
    let x = point.x;
...
fn rotate_y(point: Point3, degree: f32, orientation: Point3) -> Point3 {
...
fn rotate_z(point: Point3, degree: f32, orientation: Point3) -> Point3 {
    let x = (point.x - orientation.x) * degree.to_radians().cos()
...
fn rotate(point: Point3, degree: Point3, orientation: Point3) -> Point3 {
